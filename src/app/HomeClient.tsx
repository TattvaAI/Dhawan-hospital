...
const services = [
  { id: "orthopaedics", icon: Bone, title: "Orthopaedics", desc: "Comprehensive bone and joint care by senior surgeons." },
  { id: "trauma-care", icon: ShieldCheck, title: "Trauma Care", desc: "24×7 emergency response for accidents and fractures." },
  { id: "joint-replacement", icon: Activity, title: "Joint Replacement", desc: "Advanced hip and knee replacement with rapid recovery." },
  { id: "sports-injury", icon: HeartPulse, title: "Sports Injury", desc: "Performance-grade rehabilitation for athletes." },
  { id: "spine-care", icon: Stethoscope, title: "Spine Care", desc: "Precision spine evaluation, pain management & surgery." },
  { id: "rehabilitation", icon: Sparkles, title: "Rehabilitation", desc: "Physiotherapy-led recovery for full mobility return." },
];
            ...
            {services.map((s, i) => (
              <Reveal key={s.title} direction="up" delay={i * 0.05}>
                <div className="group relative rounded-2xl glass p-7 hover-lift overflow-hidden border border-border">
                  ...
                  <Link href={`/services?tab=${s.id}`} className="mt-4 inline-flex items-center gap-1 text-xs uppercase tracking-widest text-gold font-semibold">
          ...
          <Reveal direction="right" delay={0.1}>
            ...
            <ul className="mt-6 space-y-3.5 text-sm">
              {[
                ...
                "24x7 Emergency & Fracture Trauma Care",
                "Advanced Operating Theatres & ICU Support",
                "Plastic, Cosmetic & Microvascular Surgery",
                "Diabetes & Medicine Clinic"
              ].map((t) => (
